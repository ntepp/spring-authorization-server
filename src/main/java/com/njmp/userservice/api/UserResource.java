package com.njmp.userservice.api;
...
import com.njmp.userservice.service.UserService;
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            try {
                ...
                String access_token = JWT.create()
                        ...
                        .withClaim("roles", user.getUsrRoles().stream().map(Role::getName).collect(Collectors.toList()))
                        .sign(algorithm);
